...
methods.push('updateState','updateCheck','updateDownload','updateInstall','clipboardRead','clipboardWrite','openLink');
...
for(const [name,channel] of [['onTerminalDocked','hub:terminal-docked'],['onWindowState','hub:window-state'],['onApproval','hub:approval'],['onState','hub:state'],['onTerminal','hub:terminal'],['onServiceError','hub:service-error'],['onUpdate','hub:update']]){
