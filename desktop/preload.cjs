...
methods.push('browserPlace','browserOpen','browserNav','browserPreview','browserState','updateState','updateCheck','updateDownload','updateInstall','clipboardRead','clipboardWrite','openLink');
methods.push('agentModels','selectModel','gateway','updateAgentDisplay');
methods.push('saveSettings','projectSave','projectRemove','projectInfo','projectBranches','projectGit','projectClone','mcpSave','mcpRemove','agentMcp','agentSkills','skillAction','agentDiagnostics','moveAgent','connectAll','playground','files','installFramework','opayaSaveConfig','opayaTest','opayaForgetKey','opayaSend','opayaStop','opayaClear','windowControl');
...
for(const [name,channel] of [['onTerminalDocked','hub:terminal-docked'],['onWindowState','hub:window-state'],['onApproval','hub:approval'],['onState','hub:state'],['onTerminal','hub:terminal'],['onServiceError','hub:service-error'],['onUpdate','hub:update'],['onBrowser','hub:browser']]){
