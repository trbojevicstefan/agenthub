...
for(const [name,channel] of [['onTerminalDocked','hub:terminal-docked'],['onApproval','hub:approval'],['onState','hub:state'],['onTerminal','hub:terminal'],['onServiceError','hub:service-error']]){
