...
class OpayaAgent{
  ...
  async ensureCodex(){
    ...
    await rpc.request('initialize',{clientInfo:{name:'opaya',title:'Opaya Agent',version:'0.10.2'},capabilities:{experimentalApi:true}});rpc.notify('initialized',{});return rpc;
  }
