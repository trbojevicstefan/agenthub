...
function list(){return [...FRAMEWORKS.map(({posix,windows,...f})=>({kind:'agent',...f,local:available({posix,windows,...f},false),remote:available({posix,windows,...f},true),localCommand:process.platform==='win32'?windows:posix,remoteCommand:posix})),
