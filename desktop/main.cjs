...
if(hostMode){
  ...
  if(!app.requestSingleInstanceLock())app.quit();else{
    ...
    app.whenReady().then(async()=>{
      ...
      for(const method of ['agentUpdate','agentUpdateAll','agentUninstall','toolUpdate','installFramework','projectRemoteStop'])handlers[method]=input=>client.call(method,input,11*60*1000);
